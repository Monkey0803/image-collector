...
3.1.0 在本地素材库中加入文件内容哈希精确去重、感知哈希相似分组和可调阈值，并提供尺寸/文件大小/原图候选保留策略。图片详情面板展示完整地址、候选地址、来源元素、iframe、MIME、大小、缓存和集合信息，支持复制、打开来源、下载、编辑标签及调整集合。素材库还提供无效、未收藏、重复三种安全清理模式，以及“全选筛选结果”和“选择已加载结果”两种批量选择语义。
...
├── TODO.md             # 3.3.1 checklist and future roadmap
